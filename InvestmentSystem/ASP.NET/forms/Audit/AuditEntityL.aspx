...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AuditEntityL.aspx.cs" Inherits="ICSSoft.STORMNET.Business.Audit.Objects.AuditEntityL" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="ics-form ics-form-list">
        <h2 class="ics-form-header ics-header-listform">Записи аудита</h2>
