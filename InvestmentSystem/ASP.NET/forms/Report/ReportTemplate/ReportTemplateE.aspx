...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="ReportTemplateE.aspx.cs" Inherits="IIS.Flexberry.Reports.Forms.ReportTemplateE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="ics-form ics-form-edit">
        <h2 class="ics-form-header ics-form-header-edit">Report template</h2>
...
<div class="clearfix" runat="server" ID="ctrlOwnerBlock" >
...
<div class="clearfix" runat="server" ID="ctrlContentPathBlock">
...
<div class="clearfix" runat="server" ID="ctrlParameterFormBlock">
  <asp:Label CssClass="descLbl" ID="ctrlParameterFormLabel" runat="server" Text="Тип формы параметров" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlParameterForm" runat="server">
</asp:TextBox>
...
<div style="clear: left">
	<ac:AjaxGroupEdit ID="ctrlParameters" runat="server" ReadOnly="false" />
</div>
